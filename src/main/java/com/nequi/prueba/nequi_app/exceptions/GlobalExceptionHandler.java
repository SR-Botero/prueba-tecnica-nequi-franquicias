...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DuplicateResourceInUseException.class)
    public Mono<ResponseEntity<String>> handleDuplicateResourceException(DuplicateResourceInUseException ex) {
